...
<div class="card">
    ...
    <div class="card-body card-padding">
        {{ Form::open(['route' => 'hobby.store', 'class' => 'ajaxForm']) }}
        <div class="row">
            <div class="col-sm-offset-1 col-sm-10">
                <div class="form-group fg-float">
                    <div class="fg-line">
                        {{ Form::text('hobbyName', null, ['class' => 'form-control fg-input']) }}
        ...
        <div class="row">
            <div class="col-sm-offset-1 col-sm-10">
                {{ Form::select('hobbySubFrom', $hobbies, null, ['class' => 'form-control selectpicker', 'data-live-search' => true, 'title' => 'Choose Sub Hobby']) }}

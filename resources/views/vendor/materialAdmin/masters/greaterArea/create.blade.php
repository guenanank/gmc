...
<div class="card">
    ...
    <div class="card-body card-padding">
        ...
        <div class="row">
            <div class="col-sm-offset-1 col-sm-10">
                {{ Form::select('regencyId[]', $regencies, null, ['class' => 'form-control selectpicker', 'multiple' => true, 'data-selected-text-format' => 'count', 'data-live-search' => true, 'title' => 'Select Regencies']) }}

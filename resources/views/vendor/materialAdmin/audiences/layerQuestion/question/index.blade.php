        ...
        $('#bootgrid').bootgrid({
            ...
            formatters: {
                ...
                commands: function (column, row) {
                    var btnEdit = '<a href="#" data-href="{{ url("question") }}/' + row.questionId + '/edit" class="btn btn-icon bgm-blue command-edit" data-toggle="tooltip" title="Edit"><span class="zmdi zmdi-edit"></span></a>&nbsp;';

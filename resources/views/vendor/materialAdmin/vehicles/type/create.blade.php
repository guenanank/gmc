...
<div class="card">
    <div class="card-header">
        <h2>Create New Types <small>Master data of vehicle types.</small></h2>
    ...
    <div class="card-body card-padding">
            ...
            <div class="col-sm-offset-1 col-sm-10">
                <div class="form-group fg-float">
                    <div class="fg-line">
                        ...
                        {{ Form::label('typeName', 'Types Name', ['class' => 'fg-label']) }}
                    </div>
        ...
        <div class="row">
            <div class="col-sm-offset-1 col-sm-10">
                {{ Form::select('seriesId', $series, null, ['class' => 'form-control selectpicker', 'data-live-search' => true, 'title' => 'Select Series']) }}
        ...
        <div class="row">
            <div class="col-sm-offset-1 col-sm-10">
                <div class="form-group fg-float">
                    <div class="fg-line">
                        {{ Form::text('typeYear', null, ['class' => 'form-control fg-input']) }}
        ...
        <div class="row">
            <div class="col-sm-offset-1 col-sm-10">
                <div class="form-group fg-float">
                    <div class="fg-line">
                        {{ Form::text('typeCc', null, ['class' => 'form-control fg-input']) }}

...
<div class="card">
    <div class="card-header">
        <h2>Create New Districts <small>Master data of education.</small></h2>
        <a href="{{ action('Residence\District@index') }}" class="btn btn-icon pull-right bgm-orange" data-toggle="tooltip" data-placement="left" title="Back">
            <i class="zmdi zmdi-arrow-left"></i>
        </a>
    </div>
    <br />
    <div class="card-body card-padding">
        {{ Form::model($district, ['url' => $url, 'method' =>'patch', 'class' => 'ajaxForm']) }}
        <div class="row">

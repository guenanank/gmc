...
<div class="card">
    <div class="card-header">
        ...
        <a href="{{ action('Residence\CountryController@index') }}" class="btn btn-icon pull-right bgm-orange" data-toggle="tooltip" data-placement="left" title="Back">
            <i class="zmdi zmdi-arrow-left"></i>
        </a>
    </div>
    <br />
    <div class="card-body card-padding">
        {{ Form::model($province, ['url' => $url, 'method' =>'patch', 'class' => 'ajaxForm']) }}
        <div class="row">
            <div class="col-sm-offset-1 col-sm-10">
                <div class="form-group fg-float">
                    <div class="fg-line">
                        {{ Form::text('provinceName', null, ['class' => 'form-control fg-input']) }}
                        {{ Form::label('provinceName', 'Country Name', ['class' => 'fg-label']) }}
                    </div>
            ...
            <div class="col-sm-offset-1 col-sm-10">
                <div class="form-group fg-float">
                    <div class="fg-line">
                        ...
                        {{ Form::label('provinceCode', 'Country Code', ['class' => 'fg-label']) }}
                    </div>

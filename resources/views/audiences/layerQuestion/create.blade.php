...
<div class="card">
    <div class="card-header">
        ...
        <a href="{{ action('LayerQuestionController@index') }}" class="btn btn-float bgm-lightblue waves-circle" data-toggle="tooltip" data-placement="left" title="Back">
        ...
        <div class="row">
            <div class="col-sm-offset-1 col-sm-10">
                <div class="form-group fg-float">
                    <div class="fg-line">
                        {!! Form::text('layerQuestionDesc', null, ['class' => 'form-control fg-input']) !!}
                        {!! Form::label('layerQuestionDesc', 'Layer Question', ['class' => 'fg-label']) !!}
                    </div>
                    <small id="layerQuestionDesc" class="help-block"></small>
                </div>
            </div>
        </div>
        <br />
...
<script type="text/javascript">
    $('form').submit(function (e) {
        ...
        $.ajax({
            ...
            data: {
                layerQuestionDesc: $('input[name="layerQuestionDesc"]').val()
            },
            success: function () {
                swal({
                    title: 'Success!',

...
Route::group(['prefix' => 'layerQuestion'], function() {
    ...
    Route::delete('{layerId}', ['uses' => 'LayerController@destroy', 'as' => 'layerQuestion.delete']);
...
Route::group(['prefix' => 'question'], function() {
    ...
    Route::delete('{questionId}', ['uses' => 'QuestionController@destroy', 'as' => 'question.delete']);
});
...
Route::group(['prefix' => 'upload'], function() {
    ...
    Route::put('store', ['uses' => 'UploadController@store', 'as' => 'upload.store', 'middleware' => 'ajax']);
    ...
    Route::delete('{uploadId}', ['uses' => 'UploadController@destroy', 'as' => 'upload.delete']);
    Route::get('upload', ['uses' => 'UploadController@upload', 'as' => 'upload.upload']);
    Route::get('download', ['uses' => 'UploadController@download', 'as' => 'upload.download']);
});
...
Route::group(['prefix' => 'activity'], function() {
    ...
    Route::delete('{activityId}', ['uses' => 'ActivityController@destroy', 'as' => 'activity.delete']);
});
...
Route::group(['prefix' => 'education'], function() {
    ...
    Route::delete('{educationId}', ['uses' => 'EducationController@destroy', 'as' => 'education.delete']);
});
...
Route::group(['prefix' => 'expense'], function() {
    ...
    Route::delete('{expenseId}', ['uses' => 'ExpenseController@destroy', 'as' => 'expense.delete']);
});
...
Route::group(['prefix' => 'hobby'], function() {
    ...
    Route::delete('{hobbyId}', ['uses' => 'HobbyController@destroy', 'as' => 'hobby.delete']);
});
...
Route::group(['prefix' => 'interest'], function() {
    ...
    Route::delete('{interestId}', ['uses' => 'InterestController@destroy', 'as' => 'interest.delete']);
});
...
Route::group(['prefix' => 'media'], function() {
    ...
    Route::delete('{mediaId}', ['uses' => 'MediaController@destroy', 'as' => 'media.delete']);
});
...
Route::group(['prefix' => 'mediaGroup'], function() {
    ...
    Route::delete('{mediaGroupId}', ['uses' => 'MediaGroupController@destroy', 'as' => 'mediaGroup.delete']);
});
